							...
							<div class="card">
								...
								<div class="card-body">
                                    ...
                                    <div class="row">
										...
										<div class="col-12 col-xl-6">
											<div class="mb-3">
												<textarea name="observaciones" rows="3" cools="3" class="form-control" placeholder="Observaciones"></textarea>
											</div>
											<div class="mb-3">
									...
									<div class="col-md-12">
										...
										<button type="submit" name="editarcliente" class="btn btn-primary btn-lg justify-content-center" value="Send">Editar</button>
